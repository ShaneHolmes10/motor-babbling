...
control_panel = (
    builder
    .add_section("Joint Controls", height=200)
    .add_slider(
        "joint1", -180, 180, label="Joint 1", initial=0, on_change=on_joint1_change
    )
    .add_slider(
        "joint2", -180, 180, label="Joint 2", initial=0, on_change=on_joint2_change
    )
    .add_slider(
        "joint3", -180, 180, label="Joint 3", initial=0, on_change=on_joint2_change
    )
    .add_slider(
        "joint4", -180, 180, label="Joint 4", initial=0, on_change=on_joint2_change
    )
    .end_section()
